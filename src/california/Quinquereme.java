...
public class Quinquereme extends AdvancedRobot {
	...
	public void onScannedRobot(ScannedRobotEvent e) {
		...
		//setTurnRight(e.getBearing()); // Directly at opponent
		setTurnRightRadians(absBearing - getHeadingRadians()); // Try using the same pattern matching targeting as the gun...
